...
export function Card({ children, style }: { children: React.ReactNode; style?: React.CSSProperties }) {
  return <div style={{ background: '#fff', borderRadius: 16, padding: 16, border: `1px solid ${C.ink}12`, ...style }}>{children}</div>
}
...
export const primaryBtn: React.CSSProperties = { width: '100%', padding: 12, borderRadius: 12, border: 'none', color: '#fff', fontWeight: 900, fontSize: 15, background: `linear-gradient(135deg, ${C.red}, ${C.orange})`, cursor: 'pointer' }
